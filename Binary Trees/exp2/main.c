		...
		else
		{
			switch (Choix)
			{
                ...
                case 11 :   if(estFiliforme(Racine) == 1)
                            {
                                printf("l'arbre est philophorme !\n");
                            }
                            else
                            {
                                printf("l'arbre n est pas philophorme !\n");
                            }
                            printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nAppuyez sur une touche pour retourner au menu principal");
							getch();
                            break;
                ...
                case 12 :   if (est_peigne(Racine)||est_peigne2(Racine))
                            ...
                            break;
/*
                            EstPeigneDroit(Racine);
                            if( EstPeigneDroit(Racine))
                            {
                                printf("c'est peigne gauche\n\n\n\n");
                            }else
                            {
                                 printf("ce n'est pas peigne gauche\n\n\n\n");
                            }
                            break;

                            if(Peigne(Racine) == NULL){
                                    printf("l'arbre n'est pas peigne");

                            }
                            else{
                                printf("l'arbre est peigne");
                            }
                            //printf("Arbre charg\202\n");
                            //printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nAppuyez sur une touche pour retourner au menu principal");
                            //getch();
                            ...
                            if(EstPeigne(Racine) == 1)
                            {
                                printf("l'arbre est peinge !\n");
                            }
                            else
                            {
                                printf("l'arbre n est pas peigne !\n");
                ...
                case 13 :   printf("Saisir un entier (0 pour finir la saisie) : ");
                            scanf("%d", &valeur);
                            while (valeur != 0) {
                                ajout_val(&tree, valeur);
                                printf("Saisir un entier (0 pour finir la saisie) : ");
                                scanf("%d", &valeur);
                            }
                            system("cls");
                            printf("affiche de la 1ere arbre :\n");
                            AfficherArbre(Racine);
                            printf("\naffiche de la 2eme arbre :\n");
                            AfficherArbre(tree);
                            if (compareArbres(Racine, tree) == 1) {
                                printf("\nThe trees are equal.\n");
                            } else {
